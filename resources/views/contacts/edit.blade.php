                    ...
                    <form action="{{ route('contacts.update', $contact) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <p class="mt-1 text-sm/6 text-gray-600">Fill out the form with information about the
                                    contact you want to edit.</p>
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <input type="text" name="nickname" id="nickname"
                                                    value="{{ old('nickname', $contact->nickname) }}"
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea id="about" name="about" rows="3"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">{{ old('about', $contact->about) }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-span-full">
                                        <div class="flex flex-col-1 items-center gap-x-4">
                                            ...
                                            <input type="color" name="color" value="{{ old('color', $contact->color) }}"
                                ...
                                <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="sm:col-span-2 sm:col-start-1">
                                        <label for="birthday[day]"
                                            class="block text-sm/6 font-medium text-gray-900">Day</label>
                                        <div class="mt-2">
                                            <input type="number" name="birthday[day]"
                                                value="{{ old('birthday.day', $contact->birthday->day) }}" min="1"
                                                max="31"
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="birthday[month]"
                                            class="block text-sm/6 font-medium text-gray-900">Month</label>
                                        <div class="mt-2">
                                            <input type="number" name="birthday[month]"
                                                value="{{ old('birthday.month', $contact->birthday->month) }}" min="1"
                                                max="12"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                                        </div>
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input type="number" name="birthday[year]"
                                                value="{{ old('birthday.year', $contact->birthday->year) }}" min="1900"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                                        </div>
                                        @error('birthday.year')
                                        <p class="text-red-500">{{ $message }}</p>
                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <h3 class="mt-8 text-base/7 font-semibold text-gray-900">Phone Numbers</h4>
                                    <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6"
                                            ...
                                            <div class="mt-2">
                                                <select name="phone_numbers[{{ $index }}][dial_code]"
                                                    ...
                                                    <option value="{{ $dialCode }}" {{
                                                        old("phone_numbers.$index.dial_code", $phoneNumber->dial_code)
                                                        == $dialCode ? 'selected' : '' }}>
                                                        {{ $dialCode }}
                                                    </option>
                                                    @endforeach
                                        ...
                                        <div class="sm:col-span-2">
                                            <label for="phone_numbers[{{ $index }}][phone_number]"
                                                class="block text-sm font-medium text-gray-900">Phone number</label>
                                            <div class="mt-2">
                                                <input type="text" name="phone_numbers[{{ $index }}][phone_number]"
                                                    value="{{ old(" phone_numbers.$index.phone_number",
                                        ...
                                        <div class="sm:col-span-3">
                                            <label for="phone_numbers[{{ $index }}][label]"
                                    ...
                                    <button class="mt-2 text-blue-500 hover:underline" type="button"
                                        onclick="addPhoneNumber()">Add another phone number</button>
                                    ...
                                    <h3 class="mt-8 text-base/7 font-semibold text-gray-900">Emails</h4>
                                        ...
                                        <div class="mt-4 grid grid-cols-3 gap-x-6 gap-y-8 sm:grid-cols-6"
                                                ...
                                                <div class="mt-2">
                                                    <select name="addresses[{{ $index }}][country_id]"
                                                        ...
                                                        <option value="{{ $country->id }}" {{
                                                            old("addresses.$index.country_id", $address->country_id ??
                                                            '') == $country->id ? 'selected' : '' }}>
                                                            {{ $country->name }}
                                                        </option>
                                                        @endforeach
                                            ...
                                            <div class="sm:col-span-2 sm:col-start-1">
                                                <label for="addresses[{{ $index }}][building_number]"
                                                    class="block text-sm/6 font-medium text-gray-900">Building
                                                    Number</label>
                                                <div class="mt-2">
                                            ...
                                            <div class="sm:col-span-2">
                                                <label for="addresses[{{ $index }}][apartment_number]"
                                                    class="block text-sm/6 font-medium text-gray-900">
                                                    Apartment Number</label>
                                                <div class="mt-2">
                                                    <input type="text" name="addresses[{{ $index }}][apartment_number]"
                                                        value="{{ old('addresses.' . $index . '.apartment_number', $address->apartment_number) }}"
                                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                                                </div>
                                            ...
                                            <div class="sm:col-span-2">
                                                <label for="addresses[{{ $index }}][label]"
                                                    class="block text-sm/6 font-medium text-gray-900">Label</label>
                                                <div class="mt-2">
                        ...
                        <div class="mt-6 flex items-center justify-end gap-x-6">
                            ...
                            <button type="submit"
                                class="px-3 py-1 rounded-md bg-blue-500 text-white hover:bg-blue-600">Update</button>
                        </div>
                    </form>
