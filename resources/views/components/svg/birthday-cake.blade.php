<svg {{ $attributes->merge(['class' => 'h-6 w-6']) }} viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g id="SVGRepo_iconCarrier">
        ...
        <ellipse fill="#CCD6DD" cx="18" cy="24.25" rx="18" ry="10"></ellipse>
        <path fill="#DD2E44"
        ...
        <path fill="#F4ABBA" d="M32.233 22.543c0 9.854-28.466 9.854-28.466 0v-8.759h28.466v8.759z"></path>
        <path fill="#DD2E44"
